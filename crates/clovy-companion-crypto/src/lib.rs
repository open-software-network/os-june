...
pub mod ffi {
    ...
    /// [`KEY_BYTES`] bytes.
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_generate_identity(
        private_out: *mut u8,
        public_out: *mut u8,
    ) -> i32 {
    ...
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_pairing_session_new(
        initiator: bool,
    ...
    /// [`KEY_BYTES`] bytes for the duration of this call.
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_linked_session_new(
        initiator: bool,
        local_private: *const u8,
    ...
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_session_write(
        session: *mut Session,
        input: *const u8,
        input_len: usize,
        output: *mut u8,
    ...
    /// `output_capacity` writable bytes, and `output_len` must be writable.
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_session_read(
        session: *mut Session,
        input: *const u8,
        input_len: usize,
        output: *mut u8,
    ...
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_session_is_ready(session: *const Session) -> bool {
    ...
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_session_remote_static(
    ...
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn clovy_crypto_session_free(session: *mut Session) {
        if !session.is_null() {
    ...
    // June-named symbols are a stable compatibility ABI for already-built
    // Companion clients. New clients link the Clovy-named entry points above.

    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_generate_identity`].
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn june_crypto_generate_identity(
        private_out: *mut u8,
        public_out: *mut u8,
    ) -> i32 {
        unsafe { clovy_crypto_generate_identity(private_out, public_out) }
    }

    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_pairing_session_new`].
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn june_crypto_pairing_session_new(
        ...
        unsafe { clovy_crypto_pairing_session_new(initiator, local_private, pairing_secret) }
    }

    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_linked_session_new`].
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn june_crypto_linked_session_new(
        ...
        unsafe { clovy_crypto_linked_session_new(initiator, local_private, remote_public) }
    }

    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_session_write`].
    #[unsafe(no_mangle)]
    ...
    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_session_read`].
    #[unsafe(no_mangle)]
    ...
    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_session_is_ready`].
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn june_crypto_session_is_ready(session: *const Session) -> bool {
        unsafe { clovy_crypto_session_is_ready(session) }
    }

    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_session_remote_static`].
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn june_crypto_session_remote_static(
        session: *const Session,
        output: *mut u8,
    ) -> i32 {
        unsafe { clovy_crypto_session_remote_static(session, output) }
    }

    /// # Safety
    ///
    /// Same contract as [`clovy_crypto_session_free`].
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn june_crypto_session_free(session: *mut Session) {
        unsafe { clovy_crypto_session_free(session) }
    }
