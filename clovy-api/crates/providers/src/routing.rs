...
use clovy_config::UpstreamsConfig;
use clovy_domain::{DomainError, Transcriber, Transcript, TranscriptionRequest};
use std::sync::Arc;
...
mod tests {
    ...
    use crate::http;
    use clovy_config::{UpstreamConfig, UpstreamsConfig};
    use clovy_domain::{ModelId, ProviderCredentials, Transcriber, TranscriptionRequest};
