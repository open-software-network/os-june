...
use clovy_config::ModelProvider;
use clovy_domain::{
...
mod tests {
    ...
    use clovy_config::{DEFAULT_IMAGE_HOLD_TTL_SECS, ModelProvider};
    use clovy_domain::{
    ...
    fn sample_pending_for_user_at(user_id: &str, created_at: Instant) -> super::PendingImageCharge {
        super::PendingImageCharge {
            action: clovy_domain::ActionSlug::ImageGenerate,
            ...
            credits: clovy_domain::Credits(60),
    ...
    fn sample_output() -> super::ImageGenerateOutput {
        super::ImageGenerateOutput {
            ...
            receipt: Receipt {
                credits_charged: clovy_domain::Credits(60),
                idempotent_replay: false,
            },
        }
    }
