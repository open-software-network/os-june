...
pub(crate) const MAX_ISSUE_ATTACHMENT_BYTES: usize =
    clovy_config::ISSUE_REPORT_ATTACHMENT_MAX_BYTES;
...
// reaches clovy-api, degrading it to the context-overflow notice.
const _: () = assert!(clovy_config::DEFAULT_MAX_AGENT_CHAT_BYTES == 12 * 1024 * 1024);
const _: () = assert!(clovy_config::DEFAULT_MAX_AGENT_CHAT_BYTES >= MAX_AGENT_TOTAL_STRING_CHARS);
