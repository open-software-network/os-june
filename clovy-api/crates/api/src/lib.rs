...
pub const CLOVY_APP_VERSION_HEADER: &str = "x-clovy-app-version";
pub const CLOVY_MACOS_VERSION_HEADER: &str = "x-clovy-macos-version";
pub const LEGACY_APP_VERSION_HEADER: &str = "x-june-app-version";
pub const LEGACY_MACOS_VERSION_HEADER: &str = "x-june-macos-version";
...
mod tests {
    use super::{
        CLOVY_APP_VERSION_HEADER, LEGACY_APP_VERSION_HEADER, authenticated_route_body_cap,
        client_header,
    };
    ...
    #[test]
    fn client_version_header_prefers_clovy_and_accepts_released_june_clients() {
        let mut headers = HeaderMap::new();
        headers.insert(
            LEGACY_APP_VERSION_HEADER,
            HeaderValue::from_static("0.0.38"),
        );
        assert_eq!(
            client_header(
                &headers,
        ...
        headers.insert(CLOVY_APP_VERSION_HEADER, HeaderValue::from_static("0.0.39"));
        assert_eq!(
            client_header(
                &headers,
                CLOVY_APP_VERSION_HEADER,
