...
use clovy_domain::GeneratedVideo;
use clovy_services::{JobId, VideoAnimateParams, VideoGenerateParams, VideoStatusOutput};
...
/// rejected `model_not_priced`. Video is always Clovy-metered in the first cut.
