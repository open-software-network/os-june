...
<ol class="steps">
  ...
  <li>
    ...
    <pre><code>git clone @REPO_URL@ &amp;&amp; cd os-clovy
...
mod tests {
    ...
    fn render_links_commit_and_attestation() {
        ...
        assert!(html.contains(
            "https://github.com/open-software-network/os-clovy/commit/0123abc4567890def0123abc4567890def012345"
        ));
        assert!(html.contains(
            "git clone https://github.com/open-software-network/os-clovy &amp;&amp; cd os-clovy"
        ));
        assert!(html.contains("ghcr.io/open-software-network/clovy-api:0123abc"));
