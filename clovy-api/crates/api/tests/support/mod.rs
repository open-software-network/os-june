...
use clovy_api::{ApiLimits, ApiState, ApiStateParams, AttestationInfo, router};
use clovy_config::{
...
pub(crate) fn test_issue_report_service(
    ...
    Arc::new(IssueReportService::new(IssueReportServiceDeps {
        sink: issue_reports,
        chat_completer: Arc::new(FakeChatCompleter),
        config: clovy_config::IssueReportsConfig::default(),
    }))
}
...
pub(crate) fn test_state_with_share(
    share: Option<Arc<clovy_services::ShareService>>,
    share_viewer: clovy_api::ShareViewerInfo,
) -> ApiState {
...
pub(crate) struct TestStateDeps {
    ...
    pub(crate) share: Option<Arc<clovy_services::ShareService>>,
}
...
pub(crate) fn test_state_from_deps(deps: TestStateDeps) -> ApiState {
    test_state_from_deps_with_viewer(deps, clovy_api::ShareViewerInfo::default())
}
...
pub(crate) fn test_state_from_deps_with_viewer(
    ...
    ApiState::new(ApiStateParams {
        ...
        computer_use: clovy_config::ComputerUseConfig::default(),
        local_dev_enabled: deps.local_dev_enabled,
        token_verifier: Arc::new(FakeTokenVerifier),
        companion_store: None,
        companion_snapshot: clovy_domain::CompanionSnapshot::default(),
...
#[async_trait]
impl clovy_domain::TokenVerifier for FakeTokenVerifier {
...
impl OsAccountsClient for FakeOsAccounts {
    ...
    async fn charge(&self, _request: clovy_domain::ChargeRequest) -> Result<Receipt, DomainError> {
        Ok(Receipt {
