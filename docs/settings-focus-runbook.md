...
| `profile-builder` | shipped (JUN-145 + JUN-210): unhidden as "Profiles"; list / switch / delete around the create wizard, new chats and profile-scoped settings surfaces follow the active profile (ADR 0028). Edit-after-create is a followup |
