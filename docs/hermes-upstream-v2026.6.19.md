...
`june-approval-memory-v6` patch set before building the bundled runtime and before
...
attachment state and original order. A successful prompt consumes its detached
batch exactly once.
...
| `tui_gateway/server.py` | `1743cec5c6684651d2b7cb18b7b73a37ea99538a4f56bcd8476700ce23d4f01a` | `b0bab3ffceaa0d70f1209707d57e911769a3a6878ae381b0c7ff4a22d44fc485` |
