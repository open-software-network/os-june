...
`june-approval-memory-v9` patch set before building the bundled runtime and before
...
lock; only publication is serialized. Reset invalidates pre-reset builds, and a
failed reset restores both ownership values so the waiting prompt can recover. A
successful reset clears any obsolete lazy-build error, and a successful prompt
consumes its detached batch exactly once.
...
| `tui_gateway/server.py` | `1743cec5c6684651d2b7cb18b7b73a37ea99538a4f56bcd8476700ce23d4f01a` | `ca0029cec1d9d2c6801c45098e7911873a3ed128fc83b827c25442cc1f68bf31` |
