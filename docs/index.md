...
- [adr/0030](adr/0030-approval-safe-hermes-transport-handoff.md) - live Hermes resume atomically retires the old approval notifier generation, reports overlap proof, and retries a rejected exact completion
...
- [hermes-upstream-v2026.6.19.md](hermes-upstream-v2026.6.19.md) — current pin and local compatibility patch note (v2026.6.19, `june-approval-memory-v14`)
