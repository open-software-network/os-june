...
- [adr/0033](adr/0033-approval-safe-hermes-transport-handoff.md) - live Hermes resume atomically retires the old approval notifier generation, reports overlap proof, and retries a rejected exact completion
