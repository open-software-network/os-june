...
- [adr/0016](adr/0016-windows-dictation-helper.md) — Windows dictation uses a platform-native helper process
- [adr/0017](adr/0017-windows-dictation-keyboard-hook.md) — Windows shortcuts combine `RegisterHotKey` with a narrow keyboard hook
