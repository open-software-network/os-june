...
> **Superseded:** Continue with
> [Managed Hermes final admission remediation](2026-07-17-managed-hermes-final-admission-remediation.md).
> This third-review plan is retained as historical execution evidence; its
> archive-link, dashboard-asset, fallback-lifetime, and path-backed extraction
> steps are not the current contract.
